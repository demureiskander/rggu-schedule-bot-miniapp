...
import { initWebApp, onBackButton, setBackVisible } from './telegram.js?v=7';
import { loadState, get } from './store.js?v=7';
import { applyTheme, resolveInitialTheme } from './theme.js?v=7';
import * as screens from './screens.js?v=7';
