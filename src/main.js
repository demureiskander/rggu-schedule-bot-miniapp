...
import { initWebApp, onBackButton, setBackVisible } from './telegram.js?v=2';
import { loadState, get } from './store.js?v=2';
import { applyTheme, resolveInitialTheme } from './theme.js?v=2';
import * as screens from './screens.js?v=2';
