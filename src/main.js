...
import { initWebApp, onBackButton, setBackVisible } from './telegram.js?v=4';
import { loadState, get } from './store.js?v=4';
import { applyTheme, resolveInitialTheme } from './theme.js?v=4';
import * as screens from './screens.js?v=4';
