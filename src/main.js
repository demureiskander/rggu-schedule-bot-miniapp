...
import { initWebApp, onBackButton, setBackVisible } from './telegram.js?v=8';
import { loadState, get } from './store.js?v=8';
import { applyTheme, resolveInitialTheme } from './theme.js?v=8';
import * as screens from './screens.js?v=8';
