...
import { initWebApp, onBackButton, setBackVisible } from './telegram.js?v=40';
import { loadState, get } from './store.js?v=40';
import { applyTheme, resolveInitialTheme } from './theme.js?v=40';
import * as screens from './screens.js?v=40';
