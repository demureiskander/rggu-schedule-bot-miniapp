...
import { initWebApp, onBackButton, setBackVisible } from './telegram.js?v=41';
import { loadState, get } from './store.js?v=41';
import { applyTheme, resolveInitialTheme } from './theme.js?v=41';
import * as screens from './screens.js?v=41';
