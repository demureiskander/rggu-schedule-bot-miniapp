...
import { initWebApp, onBackButton, setBackVisible } from './telegram.js?v=3';
import { loadState, get } from './store.js?v=3';
import { applyTheme, resolveInitialTheme } from './theme.js?v=3';
import * as screens from './screens.js?v=3';
