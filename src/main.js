...
import { initWebApp, onBackButton, setBackVisible } from './telegram.js?v=6';
import { loadState, get } from './store.js?v=6';
import { applyTheme, resolveInitialTheme } from './theme.js?v=6';
import * as screens from './screens.js?v=6';
