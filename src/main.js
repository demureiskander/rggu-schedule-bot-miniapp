...
import { initWebApp, onBackButton, setBackVisible } from './telegram.js?v=5';
import { loadState, get } from './store.js?v=5';
import { applyTheme, resolveInitialTheme } from './theme.js?v=5';
import * as screens from './screens.js?v=5';
